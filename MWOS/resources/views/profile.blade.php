            ...
            <form method="POST" action="{{ route('update.profile') }}" >
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                        ...
                        <input name="PHnumber" type="tel" class="form-control form-control-lg @error('phoneNumber') is-invalid @enderror" placeholder="enter phone number" value="{{ $user->phoneNumber }}">
                        @error('phoneNumber')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
